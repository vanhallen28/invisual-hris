...
export function ChatNotifCard() {
  ...
  return (
    <Link
      href="/admin/chat"
      className="mb-4 flex items-center gap-3 rounded-xl border border-[#124bce]/30 bg-[#124bce]/10 px-4 py-3 transition-colors hover:bg-[#124bce]/15"
    >
      ...
      <span className="grid h-6 min-w-[24px] shrink-0 place-items-center rounded-full bg-[#de236e] px-1.5 text-xs font-bold text-white">
        {total > 99 ? "99+" : total}
      </span>
    </Link>
  );
