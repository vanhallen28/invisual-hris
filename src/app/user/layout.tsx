...
return (
  <div className="min-h-screen bg-[#000000] text-gray-200 flex flex-col md:flex-row font-sans selection:bg-[#2b5cd5] selection:text-white">
    ...
    <header className="md:hidden w-full bg-[#0a0a0a]/95 backdrop-blur-xl border-b border-white/5 px-5 py-4 sticky top-0 z-[99] flex items-center justify-between shadow-sm">
      ...
      <div className="w-8 h-8 rounded-full bg-[#2b5cd5]/10 text-[#b3c5ff] flex items-center justify-center font-black text-[11px] border border-[#2b5cd5]/20 shadow-inner shrink-0">
    ...
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-[#0a0a0a]/95 backdrop-blur-xl border-t border-white/5 z-[100] px-3 py-2.5 pb-safe shadow-[0_-10px_30px_rgba(0,0,0,0.8)]">
      <div className="flex justify-between items-center gap-1">
        ...
        <button onClick={openLogoutConfirmation} className="flex flex-col items-center flex-1 transition-all p-2 rounded-xl text-red-500/70 hover:text-red-500 cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-[20px] h-[20px] mb-1"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M12 9l-3 3m0 0l3 3m-3-3h12.75" /></svg>
          <span className="text-[9px] font-bold tracking-wide opacity-80">Keluar</span>
        </button>
      </div>
    </div>
