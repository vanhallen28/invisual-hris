...
export default function LogoutPage() {
  ...
  return (
    <div className="min-h-screen bg-latar flex items-center justify-center flex-col relative overflow-hidden">
      
      <div className="absolute top-[-20%] left-[-10%] w-96 h-96 bg-primer-terang/10 rounded-full blur-[100px]"></div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center animate-in fade-in duration-500">
        ...
        <div className="w-10 h-10 border-4 border-white/10 border-t-primer-terang rounded-full animate-spin mb-6 shadow-[0_0_15px_rgba(43,92,213,0.3)]"></div>
