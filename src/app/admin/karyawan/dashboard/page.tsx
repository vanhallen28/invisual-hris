        ...
        <div className="w-full flex flex-col gap-6 pb-6 font-sans animate-in fade-in duration-500">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-20">
            <div className="lg:col-span-2 bg-[#141414] border border-white/5 rounded-3xl p-6 shadow-xl">
              ...
              {pendingApprovals.length === 0 ? <div className="text-center py-10 bg-[#1a1a1a] rounded-2xl border border-white/5"><p className="text-gray-500 text-sm">Tidak ada pengajuan izin tertunda.</p></div> : (
          ...
          <div className={`${theme === 'glow' ? 'bg-[#141414] rounded-3xl' : 'bg-[#0a0a0a] rounded-xl'} border border-white/10 w-full max-w-lg shadow-2xl overflow-hidden`}>
            ...
            <form onSubmit={executeBroadcast} className="p-6 space-y-4">
              ...
              <div className="pt-2 flex justify-end gap-2">
                ...
                <button type="submit" disabled={isBroadcasting} className="px-4 py-2 bg-[#2b5cd5] text-white font-bold rounded-lg text-xs disabled:opacity-50 flex items-center justify-center gap-2">
