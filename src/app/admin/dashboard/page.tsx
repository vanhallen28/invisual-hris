    ...
    <div className="relative w-full">
      ...
      {true && (
        <div className="w-full flex flex-col gap-6 pb-6 font-sans animate-in fade-in duration-500">
          ...
          {anomalyList.length > 0 ? (
            <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 shadow-lg relative z-20">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 relative z-20">
            ...
            <BentoCell onClick={() => setActiveModal("hadir")}>
              ...
              <span className="mt-2 inline-block text-[11px] text-tint opacity-0 transition-opacity group-hover:opacity-100">Lihat daftar →</span>
            </BentoCell>
            ...
            <BentoCell onClick={() => setActiveModal("terlambat")}>
              ...
              <p className="font-display mt-2 text-3xl md:text-4xl font-black text-amber-400">{isLoading ? "-" : lateToday.length}</p>
              <span className="mt-2 inline-block text-[11px] text-tint opacity-0 transition-opacity group-hover:opacity-100">Lihat daftar →</span>
            </BentoCell>
            ...
            <BentoCell onClick={() => setActiveModal("remote")}>
              ...
              <p className="font-display mt-2 text-3xl md:text-4xl font-black text-tint-redup">{isLoading ? "-" : remoteToday.length}</p>
              <span className="mt-2 inline-block text-[11px] text-tint opacity-0 transition-opacity group-hover:opacity-100">Lihat daftar →</span>
            </BentoCell>
            ...
            <BentoCell className="col-span-2">
              <div className="flex justify-between items-center mb-5 border-b border-white/5 pb-4">
                ...
                <span className="shrink-0 bg-primer-terang/20 text-tint text-[10px] font-bold px-3 py-1.5 rounded-full border border-primer-terang/30">{pendingApprovals.length} tertunda</span>
              </div>
      ...
      {showAnomalyPopup && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="bg-kartu border border-white/10 w-full max-w-sm p-8 relative flex flex-col items-center text-center rounded-xl shadow-2xl">
              ...
              <div className="mt-1">
                {!attachedFile ? (
                  ...
                  <div className="flex items-center justify-between bg-primer-terang/10 border border-primer-terang/30 px-3 py-2 rounded-lg">
                    ...
                    <button type="button" onClick={() => setAttachedFile(null)} className="text-gray-400 hover:text-red-400 p-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4 h-4"><path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" /></svg></button>
                  </div>
                )}
              </div>
